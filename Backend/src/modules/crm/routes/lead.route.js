...
router.post('/walkin', rbac('lead:create'), validate(v.walkin), ctrl.createWalkIn);
...
router.post('/:id/move-back-from-visit', adminOnly, validate(v.moveBackFromVisit), ctrl.moveBackFromVisit);
