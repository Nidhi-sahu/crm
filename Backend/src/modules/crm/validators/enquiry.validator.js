...
const baseFields = {
  ...
  occupation: Joi.string().valid('', 'Government Job', 'Private Job', 'Business').allow(''),
...
const create = {
  body: Joi.object({
    ...
    brokerId: baseFields.brokerId.optional(),
    ...
    occupation: baseFields.occupation.optional(),
